import {time, selectElement, timeZoneElement, intervalChange} from './src/worldClock.js';
import { timerBtn, timer, intervalCount } from './src/timer.js';
import {swStartBtnS, swStartBtn, swLapBtnS , swLapBtn, swInterval, loadItemsFromLocalStorage 
...
function showStopWatch(){
    ...
    document.getElementById('worldclock').style.display='none';
    document.getElementById('timer').style.display='none';
    document.getElementById('stopwatchIcon').style.boxShadow='5px 5px 15px #000';
    document.getElementById('worldIcon').style.boxShadow='none';
    document.getElementById('timerIcon').style.boxShadow='none';
    resetClock()
}
...
document.getElementById('worldClockSection').addEventListener('click',showWorld);
document.getElementById('timerSection').addEventListener('click',showTimer);
document.getElementById('stopwatchSection').addEventListener('click',showStopWatch);
