...
const swLapBtnS=()=>{
    if(!isRunning){
        ...
        swTimer.innerText= new Date().toLocaleString('en-us',{ timeStyle:"short"},{dateStyle: 'short'})
    } else{
...
export {swLapBtnS, swStartBtnS , swStartBtn, swLapBtn, swInterval, loadItemsFromLocalStorage 
};